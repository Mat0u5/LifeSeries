...
public class GivelifeCommand extends Command {
    ...
    public boolean doubleLifeGiveLife(CommandSourceStack source, ServerPlayer self, ServerPlayer soulmate, ServerPlayer target) {
        ...
        ((IPlayer) soulmate).ls$message(ModifiableText.GIVELIFE_DOUBLELIFE_ACCEPT.get(target, ActionText.hereTextRunCommand("Click to accept", TextUtils.formatString("/givelife {}", target.getScoreboardName()))));
        return false;
    }
}
