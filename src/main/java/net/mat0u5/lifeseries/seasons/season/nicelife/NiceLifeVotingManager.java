...
public class NiceLifeVotingManager {
    ...
    public static void announceNaughtyList() {
        ...
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_vote_result"));
        ...
        delay += 90;
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_naughtylist"));
            PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
    ...
    public static void announceNiceList() {
        ...
        delay += 90;
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_start"));
            PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
        ...
        for (UUID uuid : players) {
            ...
            TaskScheduler.scheduleTask(delay, () -> {
                ServerPlayer playerNew = ref.get();
                if (playerNew != null) {
                    SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_person"));
                    PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
    ...
    public static void endNaughtyList() {
        ...
        SoundEvent voteSound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_vote_result"));
        ...
        int delay = 95;
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_countdown_3"));
            PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
            PlayerUtils.sendTitleToPlayers(PlayerUtils.getAllPlayers(), ModifiableText.NICELIFE_VOTE_COUNTDOWN_3.get(), 15, 25, 15);
        });
        delay += 40;
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_countdown_2"));
            PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
            PlayerUtils.sendTitleToPlayers(PlayerUtils.getAllPlayers(), ModifiableText.NICELIFE_VOTE_COUNTDOWN_2.get(), 15, 25, 15);
        });
        delay += 40;
        TaskScheduler.scheduleTask(delay, () -> {
            SoundEvent sound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_countdown_1"));
            PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), sound, 1f, 1);
    ...
    public static void endNiceList() {
        ...
        SoundEvent voteSound = SoundEvent.createVariableRangeEvent(LSIdentifierHelper.lifeseries("nicelife_nicelist_end"));
        PlayerUtils.playSoundToPlayers(PlayerUtils.getAllPlayers(), voteSound, 1f, 1);
