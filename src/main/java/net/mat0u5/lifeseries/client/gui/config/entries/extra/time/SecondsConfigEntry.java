package net.mat0u5.lifeseries.client.gui.config.entries.extra.time;
...
public class SecondsConfigEntry extends IntegerConfigEntry implements ITextFieldAddonPopup {
    ...
    public Component getPopupText() {
        return Component.literal(Time.seconds(value).formatReadable()).withStyle(ChatFormatting.GRAY);
    }
