...
public record LongPayload(String name, long number) implements CustomPacketPayload {
    ...
    public static final Identifier ID = LSIdentifierHelper.lifeseries("long");
...
public record LongPayload(String name, long number) implements CustomPacketPayload {
    public static final CustomPacketPayload.Type<LongPayload> ID = new CustomPacketPayload.Type<>(LSIdentifierHelper.lifeseries("long"));
