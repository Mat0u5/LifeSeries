...
public record HandshakePayload(String modVersionStr, int modVersion, String compatibilityStr, int compatibility) implements CustomPacketPayload {
    ...
    public static final Identifier ID = LSIdentifierHelper.lifeseries("handshake");
...
public record HandshakePayload(String modVersionStr, int modVersion, String compatibilityStr, int compatibility) implements CustomPacketPayload {
    ...
    public static final CustomPacketPayload.Type<HandshakePayload> ID = new CustomPacketPayload.Type<>(LSIdentifierHelper.lifeseries( "handshake"));
