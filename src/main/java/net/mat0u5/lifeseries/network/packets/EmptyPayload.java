...
public record EmptyPayload(String name) implements CustomPacketPayload {
    ...
    public static final Identifier ID = LSIdentifierHelper.lifeseries("empty");
...
public record EmptyPayload(String name) implements CustomPacketPayload {
    ...
    public static final Type<EmptyPayload> ID = new Type<>(LSIdentifierHelper.lifeseries("empty"));
