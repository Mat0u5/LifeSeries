...
public record EmptyPayload(String name) implements CustomPacketPayload {
    ...
    public static final Identifier ID = IdentifierHelper.lifeseries("empty");
...
public record EmptyPayload(String name) implements CustomPacketPayload {
    ...
    public static final Type<EmptyPayload> ID = new Type<>(IdentifierHelper.lifeseries("empty"));
