...
public enum ModifiableText {
    ...
    ,CONFIG_UPDATED_CHANGES("§7Config has been successfully updated.\nClick {}§7 to view changes.", List.of("ClickHere"))
    ...
    ,SESSION_STARTING_FINALE("§7Starting final session...")
    ...
    ,BOOGEYMAN_CHOOSE("§cThe Boogeyman is about to be chosen.")
    ,BOOGEYMAN_CHOOSE_NEW("§cA new Boogeyman is about to be chosen.")
    ...
    ,SECRETLIFE_SECRETKEEPER_UNBREAKABLE(Seasons.SECRET_LIFE, "§cTurn off 'Unbreakable Buttons' in the config to break this.")
    ...
    ,SECRETLIFE_TASK_ERROR_FINALTASK(Seasons.SECRET_LIFE, "§cThis is the final task.")
    ...
    ,SECRETLIFE_TASK_APPEND(Seasons.SECRET_LIFE, "Successfully appended or queued append")
    ,SECRETLIFE_TASK_GUESS_ERROR(Seasons.SECRET_LIFE, "Task guessing is turned off in the config")
    ,SECRETLIFE_TASK_GUESS_ERROR_SELF(Seasons.SECRET_LIFE, "You cannot guess your own task")
    ,SECRETLIFE_TASK_GUESS_ERROR_TASKS(Seasons.SECRET_LIFE, "Tasks have not been chosen yet")
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSER_ALREADY(Seasons.SECRET_LIFE, "You have already guessed that player's task")
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSER_DEAD(Seasons.SECRET_LIFE, "Dead players and Watchers cannot guess tasks")
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSER_MIN(Seasons.SECRET_LIFE, "Players below {} lives cannot guess tasks", List.of("lives"))
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSER_MAX(Seasons.SECRET_LIFE, "Players above {} lives cannot guess tasks", List.of("lives"))
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSED_DEAD(Seasons.SECRET_LIFE, "You cannot guess tasks of dead players or Watchers")
    ,SECRETLIFE_TASK_GUESS_ERROR_GUESSED_MIN(Seasons.SECRET_LIFE, "You cannot guess tasks of players below {} lives", List.of("lives"))
    ,SECRETLIFE_TASK_GUESS_ERROR_NO_BOOK(Seasons.SECRET_LIFE, "{} does not have a task book")
    ,SECRETLIFE_TASK_GUESS_ERROR_RED(Seasons.SECRET_LIFE, "You cannot guess red tasks")
    ,SECRETLIFE_TASK_GUESS_HEADER(Seasons.SECRET_LIFE, "\n{} is guessing your task:", List.of("Guesser"))
    ,SECRETLIFE_TASK_GUESS_HEADER_PUBLIC(Seasons.SECRET_LIFE, "\n{} is guessing {}'s task:", List.of("Guesser", "Guessed"))
    ,SECRETLIFE_TASK_GUESS_BODY(Seasons.SECRET_LIFE, "\"{}\"", List.of("task"))
    ,SECRETLIFE_TASK_GUESS_PROMPT(Seasons.SECRET_LIFE, "§7You must decide whether it is correct or wrong.")
    ,SECRETLIFE_TASK_GUESS_PROMPT_PUBLIC(Seasons.SECRET_LIFE, "{}§7 must decide whether it is correct or wrong.\n", List.of("Guessed"))
    ,SECRETLIFE_TASK_GUESS_VERDICT(Seasons.SECRET_LIFE, "{} {}\n", List.of("CorrectClick", "WrongClick"))
    ,SECRETLIFE_TASK_GUESS_DECISION_ERROR_BOOK(Seasons.SECRET_LIFE, "You do not have a task book")
    ,SECRETLIFE_TASK_GUESS_DECISION_ERROR_MISSING(Seasons.SECRET_LIFE, "You cannot do that right now")
    ,SECRETLIFE_TASK_GUESS_DECISION_CORRECT(Seasons.SECRET_LIFE, "{}§a correctly guessed {}§a's task", List.of("Guesser", "Guessed"))
    ,SECRETLIFE_TASK_GUESS_DECISION_CORRECT_SELF(Seasons.SECRET_LIFE, "§cYou must now go fail your task at the Secret Keeper")
    ,SECRETLIFE_TASK_GUESS_DECISION_WRONG(Seasons.SECRET_LIFE, "{}§c incorrectly guessed {}§c's task", List.of("Guesser", "Guessed"))
    ...
    ,SECRETLIFE_FINALE_TASK(Seasons.SECRET_LIFE, "Win Secret Life.")
    ...
    ,WILDLIFE_SNAIL_TEXTURE_PRESET_INFO(Seasons.WILD_LIFE,"§fClick {}§f to open the Snail Texture Presets info page on the Wiki.", List.of("ClickHere"))
    ...
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_ERROR(Seasons.WILD_LIFE, "Invalid snail skin preset")
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_ERROR_CUSTOM(Seasons.WILD_LIFE, "That player already has a custom snail skin")
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_SET_SINGLE(Seasons.WILD_LIFE, "{}'s snail skin preset was set to '{}'", List.of("Player", "skin"))
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_SET_MULTIPLE(Seasons.WILD_LIFE, "Set snail skin preset of {} targets to '{}'", List.of("number of targets", "skin"))
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_RANDOM_SINGLE(Seasons.WILD_LIFE, "Randomized {}'s snail skin preset", List.of("Player"))
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_RANDOM_MULTIPLE(Seasons.WILD_LIFE, "Randomized snail skin preset of {} targets", List.of("number of targets"))
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_RESET_SINGLE(Seasons.WILD_LIFE, "Reset {}'s snail skin preset", List.of("Player"))
    ,WILDLIFE_SNAIL_TEXTURES_PRESET_RESET_MULTIPLE(Seasons.WILD_LIFE, "Reset snail skin preset of {} targets", List.of("number of targets"))
    ...
    ,WILDLIFE_SUPERPOWER_TRIGGER_MULTIPLE(Seasons.WILD_LIFE, "Trigerred the superpower of {} targets", List.of("number of targets"))
    ,WILDLIFE_SUPERPOWER_TRIGGER_RESPONSE_MISSING(Seasons.WILD_LIFE, "§c{} does not have a superpower", List.of("Player"))
    ,WILDLIFE_SUPERPOWER_TRIGGER_RESPONSE_DEAD(Seasons.WILD_LIFE, "§cDead players cannot use superpowers")
    ,WILDLIFE_SUPERPOWER_TRIGGER_RESPONSE_COOLDOWN(Seasons.WILD_LIFE, "§c{}'s superpower is under cooldown", List.of("Player"))
    ,WILDLIFE_SUPERPOWER_TRIGGER_RESPONSE_ACTIVATED(Seasons.WILD_LIFE, "Activated {}'s superpower", List.of("Player"))
	,WILDLIFE_SUPERPOWER_TRIGGER_RESPONSE_DEACTIVATED(Seasons.WILD_LIFE, "Deactivated {}'s superpower", List.of("Player"))
    ...
    ,WILDLIFE_TRIVIA_TEXTURES_NONE(Seasons.WILD_LIFE, "§7No trivia skins have been added yet. Run '§f/trivia textures info§7' to learn how to add them.")
    ,WILDLIFE_TRIVIA_TEXTURES_LIST(Seasons.WILD_LIFE, "§7The following skins have been found: §f{}", List.of("list"))
    ,WILDLIFE_TRIVIA_TEXTURE_INFO(Seasons.WILD_LIFE,"§fClick {}§f to open the Trivia Textures info page on the Wiki.", List.of("ClickHere"))
